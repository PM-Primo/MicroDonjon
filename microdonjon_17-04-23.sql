...
INSERT INTO `item` (`id`, `nom_item`, `image_item`) VALUES
	(1, 'Dague effilée', 'img/items/01_dague_effilee.png'),
	(2, 'Armure de cuir', 'img/items/02_armure_cuir.png'),
	(3, 'Lanterne', 'img/items/03_lanterne.png'),
	(4, 'Clé rouillée', 'img/items/04_cle_rouillee.png'),
	(5, 'Gourde', 'img/items/05_gourde.png'),
	(6, 'Gourde (eau revigorante)', 'img/items/06_gourde_eau.png'),
	(7, 'Gourde (potion de soin)', 'img/items/07_gourde_potion.png'),
	(8, 'Pioche spectrale', 'img/items/08_pioche_spectrale.png'),
	(9, 'Armure rubis', 'img/items/09_armure_rubis.png'),
	(10, 'Épée du héros', 'img/items/10_epee_heros.png'),
	(11, 'Dague éclatante', NULL),
	(12, 'Épée du héros (éclatante)', NULL),
	(13, 'Coquillage de l\'amitié', 'img/items/13_coquillage_amitie.png'),
	(14, 'Bottes de vivacité', 'img/items/14_bottes_vivacite.png'),
	(15, 'Cape trompe-l\'oeil', 'img/items/15_cape_trompe_loeil.png');
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `pseudo`, `pvmax`, `pvactuels`, `gold`, `attaque`, `chapitre_en_cours`, `date_victoire`, `is_verified`) VALUES
	(16, 'toto@toto.web', '["ROLE_ADMIN"]', '$2y$13$tMnmNHNVBeHUPYQxsorioOk1oBJnmFL/AiY4S416ieaEcdYq7IuSi', 'toto', 100, 92, 45, 10, 17, NULL, 1);

-- Listage des données de la table microdonjon.user_chapitre : ~9 rows (environ)
...
-- Listage des données de la table microdonjon.user_item : ~3 rows (environ)
