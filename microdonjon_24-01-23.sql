...
-- Listage des données de la table microdonjon.chapitre : ~71 rows (environ)
INSERT INTO `chapitre` (`id`, `zone_id`, `titre_chapitre`, `type_page`) VALUES
	(1, NULL, 'Introduction', 'Standard'),
...
-- Listage des données de la table microdonjon.chap_condition : ~7 rows (environ)
INSERT INTO `chap_condition` (`id`, `chapitre_id`, `item_condition_id`, `texte_si_vrai`, `texte_si_faux`) VALUES
	(1, 6, 4, 'Vous pouvez essayer d\'utiliser la clé rouillée trouvée dans la cabine du garde pour ouvrir l\'un des coffres. \r\n<br>Vous pouvez également passer votre chemin et la conserver pour plus tard.', 'Vous pouvez essayer de crocheter l\'une des serrures avec votre dague. Ou bien ne pas tenter le diable et continuer l\'exploration du donjon.'),
...
-- Listage des données de la table microdonjon.chap_standard : ~56 rows (environ)
...
-- Listage des données de la table microdonjon.combat : ~17 rows (environ)
...
-- Listage des données de la table microdonjon.doctrine_migration_versions : ~1 rows (environ)
...
INSERT INTO `item` (`id`, `nom_item`, `image_item`) VALUES
	(1, 'Dague effilée', NULL),
	(2, 'Armure de cuir', NULL),
	(3, 'Lanterne', NULL),
	(4, 'Clé rouillée', NULL),
	(5, 'Gourde', NULL),
	(6, 'Gourde (eau revigorante)', NULL),
	(7, 'Gourde (potion de soin)', NULL),
	(8, 'Pioche spectrale', NULL),
	(9, 'Armure rubis', NULL),
	(10, 'Épée du héros', NULL),
	(11, 'Dague éclatante', NULL),
	(12, 'Épée du héros (éclatante)', NULL),
	(13, 'Coquillage de l\'amitié', NULL),
	(14, 'Bottes de vivacité', NULL),
	(15, 'Cape trompe-l\'oeil', NULL);

-- Listage des données de la table microdonjon.messenger_messages : ~1 rows (environ)
...
INSERT INTO `monstre` (`id`, `nom_monstre`, `pvmax_monstre`, `attaque_monstre`, `image_monstre`) VALUES
	(1, 'Gobelin Physionomiste', 10, 3, NULL),
	(2, 'Malle Polymorphe', 10, 3, NULL),
	(3, 'Drosera Insatiable', 10, 3, NULL),
	(4, 'Ouvrage Vorace', 10, 3, NULL),
	(5, 'Gardien Osseux', 10, 3, NULL),
	(6, 'Horreur Tentaculaire', 10, 3, NULL),
	(7, 'Marchand Itinérant', 10, 3, NULL),
	(8, 'Perfide Sorcier de Vangläs', 10, 3, NULL);

-- Listage des données de la table microdonjon.sortie_combat : ~11 rows (environ)
...
-- Listage des données de la table microdonjon.sortie_standard : ~104 rows (environ)
INSERT INTO `sortie_standard` (`id`, `chap_standard_id`, `chapitre_id`, `texte_lien`) VALUES
	...
	(77, 42, 62, 'Faire une offrande de 100 pièces d\'or'),
	(78, 42, 63, 'Faire une offrande de 150 pièces d\'or'),
	(79, 42, 64, 'Faire une offrande de 200 pièces d\'or'),
	(80, 42, 65, 'Faire une offrande de 250 pièces d\'or'),
	(81, 42, 66, 'Faire une offrande de 300 pièces d\'or'),
...
-- Listage des données de la table microdonjon.user : ~1 rows (environ)
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `pseudo`, `pvmax`, `pvactuels`, `gold`, `attaque`, `chapitre_en_cours`, `date_victoire`, `is_verified`) VALUES
	(16, 'toto@toto.web', '[]', '$2y$13$tMnmNHNVBeHUPYQxsorioOk1oBJnmFL/AiY4S416ieaEcdYq7IuSi', 'toto', 100, 411, 399, 10, NULL, NULL, 1);

-- Listage des données de la table microdonjon.user_chapitre : ~0 rows (environ)

-- Listage des données de la table microdonjon.user_item : ~8 rows (environ)
...
-- Listage des données de la table microdonjon.user_zone : ~0 rows (environ)

-- Listage des données de la table microdonjon.zone : ~20 rows (environ)
INSERT INTO `zone` (`id`, `nom_zone`, `description_zone`, `fichier_map`) VALUES
	(1, 'Corridor d\'entrée', NULL, NULL),
	(2, 'Quartiers de la garde', NULL, NULL),
	(3, 'Salle des coffres', NULL, NULL),
	(4, 'Jardin d\'hiver', NULL, NULL),
	(5, 'Grande bibliothèque', NULL, NULL),
	(6, 'Chambre noire', NULL, NULL),
	(7, 'Passage dérobé', NULL, NULL),
	(8, 'Quartiers du contremaître', NULL, NULL),
	(9, 'Couloir arc-en-ciel', NULL, NULL),
	(10, 'Fontaine cristalline', NULL, NULL),
	(11, 'Poste de garde du pont de singe', NULL, NULL),
	(12, 'Pont de singe', NULL, NULL),
	(13, 'Armurerie', NULL, NULL),
	(14, 'Escaliers en colimaçon', NULL, NULL),
	(15, 'Torrent caverneux', NULL, NULL),
	(16, 'Berge aux sables blancs', NULL, NULL),
	(17, 'Statue du Héros', NULL, NULL),
	(18, 'Autel de la Déesse', NULL, NULL),
	(19, 'Échoppe itinérante', NULL, NULL),
	(20, 'Salle du trône', NULL, NULL);
