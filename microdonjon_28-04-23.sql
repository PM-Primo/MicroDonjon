...
-- Listage des données de la table microdonjon.user : ~3 rows (environ)
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `pseudo`, `pvmax`, `pvactuels`, `gold`, `attaque`, `chapitre_en_cours`, `date_victoire`, `is_verified`) VALUES
	(16, 'toto@toto.web', '["ROLE_ADMIN"]', '$2y$13$tMnmNHNVBeHUPYQxsorioOk1oBJnmFL/AiY4S416ieaEcdYq7IuSi', 'toto', 100, 100, 15, 10, 6, NULL, 1),
	(17, 'grugru@grugru.web', '[]', '$2y$13$RDM.X2Kc.BngfRdRd4F1c.rKOR0CiKhZGqPg7Nz09874QaPBwvCJy', 'gru', 100, 100, 0, 10, NULL, NULL, 0),
	(18, 'grugru@gmail.com', '[]', '$2y$13$c.Q.xu//vaU7eZ1SbifBPOS14Mh2UWfEoJOW5wt1UrJH9QxM1MrVa', 'grugru', 100, 100, 0, 10, NULL, NULL, 0),
...
-- Listage des données de la table microdonjon.user_item : ~4 rows (environ)
