...
INSERT INTO `chapitre` (`id`, `zone_id`, `titre_chapitre`, `type_page`) VALUES
	...
	(79, 10, 'test', 'Standard'),
	(83, 1, 'Ceci est un test', 'Standard');
...
INSERT INTO `chap_standard` (`id`, `chapitre_id`, `item_prendre_id`, `item_perdre_id`, `texte_chapitre`, `modif_gold`, `modif_pv`, `modif_attaque`) VALUES
	...
	(59, 79, NULL, NULL, 'Premier test', NULL, -15, 6),
	(60, 83, NULL, NULL, 'Ceci est un test', 15, -15, NULL);
...
INSERT INTO `item` (`id`, `nom_item`, `image_item`, `description_item`) VALUES
	...
	(11, 'Dague éclatante', NULL, 'Cet objet prévu dans la version initiale du jeu a été retiré de la version finale'),
	(12, 'Épée du héros (éclatante)', NULL, 'Cet objet prévu dans la version initiale du jeu a été retiré de la version finale'),
...
INSERT INTO `reset_password_request` (`id`, `user_id`, `selector`, `hashed_token`, `requested_at`, `expires_at`) VALUES
	(1, 19, '9bLVDqbdNFPVru9l6JKS', 'By4eeDg+0sQse1Ro05x4UCuiVkqTw78kLGMBMHXJq8Q=', '2023-05-10 14:16:12', '2023-05-10 15:16:12');
...
INSERT INTO `sortie_standard` (`id`, `chap_standard_id`, `chapitre_id`, `texte_lien`) VALUES
	...
	(112, 60, 17, 'Première sortie'),
	(113, 60, 26, 'Seconde sortie'),
	(115, 60, 70, 'Troisième sortie');

-- Listage des données de la table microdonjon.user : ~12 rows (environ)
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `pseudo`, `pvmax`, `pvactuels`, `gold`, `attaque`, `chapitre_en_cours`, `date_victoire`, `is_verified`) VALUES
	(16, 'toto@toto.web', '["ROLE_ADMIN"]', '$2y$13$tMnmNHNVBeHUPYQxsorioOk1oBJnmFL/AiY4S416ieaEcdYq7IuSi', 'PM_67', 100, 88, 60, 10, 7, NULL, 1),
	...
	(21, 'TestRateLimiter2@gmail.com', '[]', '$2y$13$kAH9aywg3bf9WJpAr25z2.QEUnhByq0QS65DSaFxByiSvE4meXA4C', 'RateLimiterTest2', 100, 100, 0, 10, 1, NULL, 1),
	(22, 'burneraccount@gmail.com', '[]', '$2y$13$AcfBDB1Dwbww6GSnlUK4w.w2SUYcVjy5sC/.HmACvwVClbM35se7S', 'Burner', 100, 100, 0, 10, NULL, NULL, 0),
	(31, 'zzzz@zzzz.com', '[]', '$2y$13$8oIOmW3Z9ARJkbjcMSUf1e4njQSXb9JBGuZ6dw.Cjm1XBS/uZyXf2', 'zzzz', 100, 100, 0, 10, NULL, NULL, 1),
	(32, 'yyyy@yyyy.com', '[]', '$2y$13$QW3ZJfrmV/zug.o6KW.KPenZWO2VNFr6QrsZEXzbi3aTNumqgx7SC', 'yyyy', 100, 100, 0, 10, NULL, NULL, 1),
	...
	(35, 'pierrem.primo@microdonjon.fr', '["ROLE_ADMIN"]', '$2y$13$9hLNUq5SPVtCP1VGlaukOuZFZOnJMBxdG/ac5mnpZhteHqTgA2L.y', 'Pierre-Marie', 100, 100, 0, 10, NULL, NULL, 1);

-- Listage des données de la table microdonjon.user_chapitre : ~10 rows (environ)
...
-- Listage des données de la table microdonjon.user_item : ~17 rows (environ)
...
INSERT INTO `zone` (`id`, `nom_zone`, `description_zone`, `fichier_map`, `order_zone`) VALUES
	(1, 'Corridor d\'entrée', 'Un long corridor éclairé par une rangée de lanternes. Ce corridor est la seule entrée connue du donjon.', NULL, 2),
	(2, 'Quartiers de la garde', 'Les quartiers des gardes du donjon. Les gobelins responsables de la sécurité peuvent s\'y reposer et s\'entraîner au combat. ', NULL, 3),
	(3, 'Salle des coffres', 'De nombreux trésors amassés par les maîtres du donjon sont entreposés dans la salle des coffres. Pièces d\'or, pierres précieuses et objets magiques débordent de malles remplies à craquer.', NULL, 4),
	(4, 'Jardin d\'hiver', 'Une serre en plein coeur du donjon. Toutes sortes de plantes vénéneuses y sont cultivées afin de réaliser les potions et enchantements du maître du donjon. ', NULL, 5),
	(5, 'Grande bibliothèque', 'Les archives du donjon, on y trouve tous les ouvrages que l\'on oserait espérer et bien plus encore. Recettes de cuisine, précis de divination, guides de développement personnel ou encore littérature scientifique ... Dommage que la plupart de ces ouvrages soient rédigés en écritures runiques indéchiffrables pour le commun des mortels.', NULL, 6),
	(6, 'Chambre noire', 'Qui sait quels mystères peuvent bien vous attendre dans les ténèbres dévorantes de cette chambre obscure ?', NULL, 7),
	(7, 'Passage dérobé', 'Grâce à votre sens aiguisé de l\'observation vous avez pu trouver ce passage habilement dissimulé dans le donjon. Il vous permet d\'éviter une portion significative et de nombreuses embûches !', NULL, 8),
	(8, 'Quartiers du contremaître', 'Les quartiers du contremaître ayant supervisé la conception du donjon ! Décédé tragiquement dans un éboulement, son esprit hante toujours ses anciens quartiers. Féru d\'énigmes et de devinettes, l\'ectoplasme attent patiemment les explorateurs du donjon afin de leur soumettre ses créations.', NULL, 9),
	(9, 'Couloir arc-en-ciel', 'Un couloir au dalles multicolores et magnifiques. Ce patchwork chromatique est un régal visuel, surtout en comparaison avec les teintes gris-brunâtres du reste du donjon. Vous y séjourneriez bien quelques minutes de plus ... s\'il n\'était pas aussi dangereux ...', NULL, 10),
	(10, 'Fontaine cristalline', 'Une fontaine aux motifs ouvragés taillés à même le cristal. L\'eau qui en jaillit a l\'air si désaltérante ! S\'agirait-il d\'un mirage ?', NULL, 11),
	(11, 'Poste de douane', 'Une minuscule cahute permettant de contrôler les entrées-sorties d\'un pont de singe à l\'air fragile', NULL, 12),
	(12, 'Pont de singe', 'Un pont aux cordes effilochées et aux planches vermoulues. Son air fragile n\'inspire qu\'assez peu confiance relativement au fait qu\'il surplombe un profond torrent aux remous infernaux.', NULL, 13),
	(13, 'Armurerie', 'Le stockage des armures du donjon ! Oserez vous les enfiler ou craindrez vous de vous attirer les foudres du maître du donjon ?', NULL, 14),
	(14, 'Escaliers en colimaçon', 'Un escalier somme toute assez classique descendant en vrille dans les entrailles du donjon.', NULL, 15),
	(15, 'Torrent caverneux', 'Un torrent blanc d\'écume et aux remous chaotiques. Vous préférez ne pas penser aux créatures pouvant sommeiller dans les abysses inquiétantes de ce cours d\'eau.', NULL, 16),
	(16, 'Berge aux sables blancs', 'Un petit coin de paradis au sein du donjon. Enlevez vos bottes et faites profiter vos pieds du doux contact avec le sable blanc ... Dommage que le plafond de la grotte ne masque le ciel bleu ...', NULL, 17),
	(17, 'Statue du Héros', 'Une statue du héros ayant jadis ramené la paix sur les terres d\'Ängerjälg. Il brandit son épée, l\'air grave. Vous tenterez d\'être digne de son héritage.', NULL, 18),
	(18, 'Autel de la Déesse', 'Un autel à l\'effigie de la déesse accompagné d\'une petite boîte à donations. Bien sûr, l\'argent ne fait pas le bonheur ... mais parfois il peut tout de même un petit peu aider. ', NULL, 19),
	(19, 'Échoppe itinérante', 'Tout ce que vous pouviez désirer acheter et bien plus encore ! Petite échoppe traversant le donjon à la recherche de nouveaux clients. Pensez-vous qu\'elle arrive à rentrer dans ses frais ?', NULL, 20),
	(20, 'Salle du trône', 'L\'antre du maître du donjon. Personne n\'a jamais réussi à y pénétrer, tout ce qu\'il s\'y passe est strictement confidentiel !', NULL, 21),
	(21, 'Abords du donjon', 'Cela fait plusieurs décennies déjà que la verte plaine d\'Ängerjalg s\'est ternie. La végétation, autrefois luxuriante a cédé la place à des marécages brunâtres embourbant les villages alentour. Il est votre devoir de restaurer la paix sur ces terres !', NULL, 1);
